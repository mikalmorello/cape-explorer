...
single-item share link used only for harvesting the cover image, kept
independent of the album's own sharing state so a gated `photoAlbum`
can still surface a public cover.
