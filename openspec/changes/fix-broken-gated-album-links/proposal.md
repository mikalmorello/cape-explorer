...
- Remove `photoAlbum` from the 34 locations that had a
  ...
  Pond, Hog Island Beer Co. (the last seventeen added after this
  proposal was drafted, using
  the same pattern pending this decision). Their
