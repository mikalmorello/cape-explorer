...
- Remove `photoAlbum` from the 23 locations that had a
  ...
  Co., Race Point Beach (the last six added after this proposal was
  drafted, using the same pattern pending this decision). Their
